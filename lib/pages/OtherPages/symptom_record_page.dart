...
//from datepicker
  Widget buildFrom() {
    if (disableDateTime) {
      return buildDisabledField(
          header: 'Symptom Started At:', text: Utils.toDate(fromDate));
    }
    return buildHeader(
      header: 'Symptom Started At:',
      child: Row(
        children: [
          Expanded(
            flex: 3,
...
//to datepicker
  Widget buildTo() {
    if (disableDateTime) {
      return buildDisabledField(
          header: 'Symptom Ended At:', text: Utils.toDate(fromDate));
    }
    return buildHeader(
      header: 'Symptom Ended At:',
      child: Row(
        children: [
          Expanded(
            flex: 3,
